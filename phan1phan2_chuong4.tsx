...
console.log(`
  Vì Ctt < C (43880.5 < ${khaNangTaiTrong_C7212})  => Ổ lăn thỏa điều kiện đã chọn của tải trọng động
`)
...
console.log(`
  Vì Ctt < C (43880.5 < ${khaNangTaiTrong_C7214})  => Ổ lăn thỏa điều kiện đã chọn của tải trọng động
`)
